...
\subsubsection{Inwiefern ist Christus der oberste Herrscher der Welt, und wie zeigt sich das?}
	...
	\end{bibeltext}
\subsection{Eine göttliche Offenbarung}
...
\subsection{Wie lese ich die Bible richtig}
\begin{quote}
	Unklare Bibelstellen müssen im Licht klarer Bibelstellen ausgelegt werden - denn die Schrift kann sich nicht widersprechen.
\end{quote}
